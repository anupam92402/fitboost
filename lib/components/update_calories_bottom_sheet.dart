...
class UpdateCalorieBottomSheet extends StatefulWidget {
  String id;
  UpdateCalorieBottomSheet({required this.id});

  @override
  State<UpdateCalorieBottomSheet> createState() =>
      _UpdateUserBottomSheetState();
}

class _UpdateUserBottomSheetState extends State<UpdateCalorieBottomSheet> {
  @override
        ...
        child: Center(
          child: Column(
            children: <Widget>[
              ...
              Row(
                ...
                children: [
                  Expanded(
                    flex: 1,
                    child: TextFormField(
                      initialValue: provider.foodEaten,
              ...
              TextButton(
                onPressed: () {
                  var closeBottomSheet = provider.updateUserCalories(widget.id);
                ...
                child: const Text("Update Calories"),
              )
            ],
          ),
        ),
